...
This is something I use to keep up with the compromised extensions.  I've done my best to find all publicly available malicious extension IDs but please feel free to let me know if I missed some and I'll be happy to update the list.  I've also included a simple bash script to check the user's current extension directory and compared to the known compromised list. 
